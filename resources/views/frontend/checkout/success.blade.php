    ...
    <div class="flex items-center justify-center h-screen">
      <div>
        <div class="flex flex-col items-center space-y-2">
          ...
          <a href="{{ route('home') }}"
            class="inline-flex items-center px-4 py-2 text-white bg-gray-600 border border-gray-600 rounded rounded-full hover:bg-gray-700 focus:outline-none focus:ring">
