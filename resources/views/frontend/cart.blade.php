            ...
            <form class="mt-12">
                <section aria-labelledby="cart-heading">
                    ...
                    <ul role="list" class="divide-y divide-gray-200 border-b border-t border-gray-200">
                        ...
                        <li class="flex py-6">
                            <div class="flex-shrink-0">
                                <img src="https://tailwindui.com/img/ecommerce-images/shopping-cart-page-01-product-01.jpg" alt="Front side of sienna cotton t-shirt." class="h-24 w-24 rounded-md object-cover object-center sm:h-32 sm:w-32">
                            </div>
