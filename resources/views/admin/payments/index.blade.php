            ...
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        ...
                        <tr>
                            <td class="whitespace-nowrap py-2 pl-4 pr-3 text-sm text-gray-500 sm:pl-0">{{ $payment->order->number }}</td>
                            <td class="whitespace-nowrap px-2 py-2 text-sm text-gray-900">452343</td>
                            <td class="whitespace-nowrap px-2 py-2 text-sm text-gray-500">${{ $payment->order->total_price }}</td>
                            ...
                            <td class="whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-900">{{ $payment->formatted_created_at }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
