<x-admin.app title="Products | Create">
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <div x-data="{ name: '{{ old('name') }}' }" class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-gray-500 sm:max-w-md">
                                <input type="text" name="price" id="price" autocomplete="price" value="{{ old('price') }}" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="$188">
                            </div>
                            @error('price')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-gray-500 sm:max-w-md">
                                <input type="text" name="quantity" id="quantity" autocomplete="quantity" value="{{ old('quantity') }}" class="block flex-1 border-0 bg-transparent py-1.5 pl-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="188">
                            </div>
                            @error('quantity')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="sm:col-span-4">
                        <div class="flex items-center gap-x-3">
                            ...
                            <input id="featured" name="featured" type="checkbox" value="1" {{ old('featured') ? 'checked' : '' }} class="h-4 w-4 rounded-md border-gray-300 text-gray-600 focus:ring-gray-600">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button type="submit" class="rounded-md bg-gray-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500">Add Product</button>
            </div>
    </form>
</x-admin.app>
